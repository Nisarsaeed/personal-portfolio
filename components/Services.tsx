    ...
    >
      ...
      <div className="relative h-[330px] w-[1030px] md:h-[450px] md:w-[1150px] lg:h-[900px] lg:w-[1500px] mt-20 ">
        {serviceItems.map((item) => (
          ...
          >
            <div
              className="flex justify-center font-medium bg-lightLavender hover:bg-white hover:font-extrabold items-center h-full w-full flex-col text-black p-2"
              style={hexStyle}
            >
              <Image
                src={item.img}
                ...
                className="h-7 md:h-10 lg:h-20 object-contain m-2"
              />
              <div className="text-xs md:text-sm text-center lg:text-lg ">{item.title}</div>
            </div>
          </div>
        ))}
...
const serviceItems = [
  ...
  },
  {
  ...
  },
   {
     ...
     position: " top-[7em] left-[21em] md:top-[9em] md:left-[19em] lg:top-[18em] lg:left-[14em]",
   },
   {
     id: 4,
     img: "/s4.png",
     title: "Database Management",
     position: "top-[7em] right-[21em] md:top-[9em] md:right-[19em] lg:top-[18em] lg:right-[14em]",
   },
   {
     id: 5,
     img: "/s5.png",
