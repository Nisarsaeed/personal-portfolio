...
const Hero = () => {
  return (
    <main className="relative flex flex-col justify-center items-center h-screen w-full px-7">
      <div className="relative h-full w-full flex flex-col justify-center items-center ">
      <p className="sm:text-6xl text-4xl  font-bold z-20  py-6 text-neutral-700 dark:text-white w-screen md:max-w-[80%] leading-relaxed lg:leading-snug text-center md:mx-auto px-4">
